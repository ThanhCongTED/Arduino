...
const char HTTP_HELP[]             PROGMEM =
 ...
 "</table>"
 "<p/>Github <a href='https://thanhcongted.com'>https://thanhcongted.com</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
#else
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>ThanhCongTED_esp8266</h3><hr><dl>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>ThanhCongTED</dt><dd>{1}</dd>";
...
const char S_brand[]              PROGMEM = "ThanhCongTED";
...
#ifdef ESP8266
    const char S_ssidpre[]        PROGMEM = "ThanhCongTED";
#elif defined(ESP32)
